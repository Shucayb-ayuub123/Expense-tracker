  ...
  return (
    <div className="dashbaord mt-5">
      <div className="grid grid-cols-1 md:grid-cols-2  items-center space-y-6 ">
        ...
        <div className=" flex justify-center items-center ml-10  md:flex">
          <button
            className="mr-10 bg-red-500 px-10 py-2 text-white rounded-md w-full md:w-70 right-0 "
      ...
      <div className=" grid grid-cols-1 mt-7 sm:flex justify-center items-center w-11/12 m-auto gap-4">
        <div className=" w-full sm:w-1/2 shadow-lg p-6 rounded-lg min-h-0 h-90">
        ...
        <div className=" w-full sm:w-1/2 shadow-lg p-5 rounded-lg  h-90">
