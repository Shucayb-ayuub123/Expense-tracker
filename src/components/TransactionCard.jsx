...
const TransactionCard = ({Balance  , Income , expenses}) => {
  return (
    <div className=" flex justify-center items-center flex-col mt-10">
      <div className=" mx-auto w-11/12 sm:w-11/12 bg-gray-100 p-10 rounded-md">
        <p>Current Balance</p>
        <h1 className="text-3xl font-bold mt-2">${Balance}</h1>
      </div>
      <div className=" grid grid-cols-1  sm:flex gap-4 w-11/12 mt-3">

  <div className=" w-full sm:w-1/2 p-5 bg-white rounded-lg shadow-md h-40">
